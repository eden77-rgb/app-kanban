...
export default function Tache({ task }) {
    ...
    return (
        <div
            ...
            <h3 className="m-0 mb-2 text-[1.1rem] font-semibold text-white">
                {task.title}
            </h3>

            <h2 className="m-0 mb-3 text-[0.85rem] text-[#a1a1aa] font-normal">
                {task.date}
            </h2>

            <h3 className="m-0 text-[0.8rem] inline-block bg-[#242424] px-2 py-1 rounded-[6px] text-[#b0b0b0]">
                Assigné à {task.assigne}
            </h3>
        </div>
    )
}